...
<script type="text/javascript">
	$(function(){
		...
		$("#searchActivityList").keydown(function (e) {
			if (13 == e.keyCode) {
				$.ajax({
					url: "workbench/clue/searchActivityListConvert.do",
					type: "get",
					data: {
...
<body>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="createTransactionForm" action="workbench/clue/convert.do" method="post">
		  	<input type="hidden" name="isCreateTransaction" value="true">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="tradeName" name="transactionName">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
